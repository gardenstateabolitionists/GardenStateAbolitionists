      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 flex justify-between">
            <Link href="/the-gospel/great-commission" className="text-green-700 font-semibold hover:underline">
              &larr; Abolitionism &amp; the Great Commission
            </Link>
            <Link href="/the-gospel/answer-to-abortion" className="text-green-700 font-semibold hover:underline">

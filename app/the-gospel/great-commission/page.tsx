      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <p>
              Certainly, if Jesus has anything in mind regarding which commandments should be taught, He has these greatest in mind. Throughout the Gospels, we see that our obligation to love our neighbor was one of the main emphases of Christ&apos;s teaching ministry (<a href="https://biblia.com/bible/esv/matthew/7/12" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">Matt. 7:12</a>, <a href="https://biblia.com/bible/esv/luke/10/25-37" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">Luke 10:25-37</a>, <a href="https://biblia.com/bible/esv/john/15/12-14" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">John 15:12-14</a>, <a href="https://biblia.com/bible/esv/matthew/25/31-46" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">Matt. 25:31-46</a>). So, if as part of the Great Commission, Christ commands that these two be taught, the question then arises: what do they entail?
            </p>

            <p>
              If you love your neighbor as yourself, will you stand idly by while he is legally dismembered, even though he has committed no crime, and wronged no one? Will you stand idly by while two of your neighbors (in this country alone) are so butchered every minute? While 3500 neighbors are ripped limb from limb every day? Or will you content yourself with token expressions of opposition to this great evil? If you simply listen to one &ldquo;sanctity of life&rdquo; sermon a year, of what benefit is that? If you are a Christian, do you not already know that life is sacred? Have you not read that human beings are created in the image of God (<a href="https://biblia.com/bible/esv/genesis/1/27" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">Gen 1:27</a>)? Are you so dull of mind and spirit that you need to be reminded once a year that murdering children is wrong? Do you not rather need to be exhorted to action? Where is the frequent and thunderous call from the pulpits to rise up as the Body of Christ and put an end to this great evil? Where is the resounding call to love justice, correct oppression, and take up the cause of the fatherless (<a href="https://biblia.com/bible/esv/isaiah/1/17" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">Isa. 1:17</a>)? Where is the rebuke of the carnal, the slothful, and the worldly weekly pew-fillers? Where is the call for such to repent of their sins and begin the exercise of true religion (<a href="https://biblia.com/bible/esv/james/1/27" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">Jas. 1:27</a>)? The silence of our pulpits is so deafening that it could shatter every stained glass window, flip every pew, and wake every dead man from his grave.
            </p>

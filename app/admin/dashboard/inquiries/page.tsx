      ...
      {!loading && !error && inquiries.length > 0 && (
        <>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {paginatedInquiries.map((inquiry) => (
                    <tr key={inquiry.id} className={`border-b hover:bg-gray-50 ${selectedIds.has(inquiry.id) ? 'bg-green-50/50' : ''}`}>
          ...
          <div className="sm:hidden space-y-3">
            {paginatedInquiries.map((inquiry) => (
              <div key={inquiry.id} className={`bg-white rounded-lg border p-4 space-y-2 ${selectedIds.has(inquiry.id) ? 'ring-2 ring-green-200 bg-green-50/50' : ''}`}>

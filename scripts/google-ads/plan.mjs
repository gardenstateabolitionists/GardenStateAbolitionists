  ...
  },
  {
    ...
    adGroups: [
      ...
      },
      {
        ...
        cpcBidUsd: 2.0,
        finalUrl: 'https://www.gardenstateabolitionists.org/abolition-bills',
        keywords: [
          { text: 'new-jersey abortion law 2026',       match: 'PHRASE' },
          { text: 'new-jersey abortion law after dobbs', match: 'PHRASE' },
          { text: 'new-jersey proposal 3 abortion',     match: 'PHRASE' },
      ...
      },
      {
        ...
        cpcBidUsd: 2.0,
        finalUrl: 'https://www.gardenstateabolitionists.org/abolition-bills/components',
        keywords: [
